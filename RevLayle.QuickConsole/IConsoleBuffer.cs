...
public interface IConsoleBuffer
{
    ...
    /// </summary>
    /// <param name="textWriter"><see cref="TextWriter"/> buffer will be written to.</param>
    ...
    /// 
    bool IsOutOfBounds(int x, int y, int width, int height);
    ...
    bool IsFullyInBounds(int x, int y, int width, int height);
    ...
    /// <param name="cell">A <see cref="ConsoleBufferCell"/> value to put in the cell</param>
    ...
    /// <param name="cell">The <see cref="ConsoleBufferCell"/> value to fill the rectangle with</param>
    ...
    /// <param name="cell">The <see cref="ConsoleBufferCell"/> value tto draw the box frame with</param>
    ...
    /// <param name="width">Width of the box.</param>
    /// <param name="height">Height of the box</param>
    /// <param name="cellSides">The <see cref="ConsoleBufferCell"/> value to draw the left and right box frame sides with</param>
    /// <param name="cellTopBottom">The <see cref="ConsoleBufferCell"/> value to draw the top and bottom box frame sides with</param>
    /// <param name="cellCorner">The <see cref="ConsoleBufferCell"/> value tto draw the box corners with</param>
    void Box(int x, int y, int width, int height, ConsoleBufferCell cellSides, ConsoleBufferCell cellTopBottom,
    ...
    /// <param name="direction">A valid <see cref="LineDirection"/> to indicate if the line is horizontal or vertical</param>
    ...
    /// <summary>
    /// Gets The <see cref="ConsoleBufferCell"/> value from the console buffer at position provided.
    /// </summary>
    ...
    /// <returns><see cref="ConsoleBufferCell"/> value of the cell</returns>
    ...
    /// <param name="buffer">An external object, implementing <see cref="IConsoleBuffer"/>, that will be drawn onto this buffer</param>
    ...
    /// <returns>A new instance implementing <see cref="IConsoleBuffer"/> with the copied cells plus the width and height
    /// provided.</returns>
