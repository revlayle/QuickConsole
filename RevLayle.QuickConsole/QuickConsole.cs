...
public static class QuickConsole
{
    ...
    public static void SetColor(QuickConsoleColor color) => _buffer.SetColor(color);
    public static void SetBackgroundColor(QuickConsoleColor color) => _buffer.SetBackgroundColor(color);
